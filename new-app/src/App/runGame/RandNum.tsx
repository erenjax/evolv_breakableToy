...
const RandomNumber = ({randomNumber, setRandomNumber, setShowAlert, setTries, setGuess, setLightArray}: {randomNumber: Code.Code, setRandomNumber: React.Dispatch<React.SetStateAction<Code.Code>>, setShowAlert: React.Dispatch<React.SetStateAction<boolean>>, setTries: React.Dispatch<React.SetStateAction<number>>, setGuess: React.Dispatch<React.SetStateAction<any[]>>, setLightArray: React.Dispatch<React.SetStateAction<string[]>>}) => {
