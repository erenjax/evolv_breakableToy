...
const HelpModal = ({showHelpModal, setShowHelpModal}: {showHelpModal: boolean, setShowHelpModal: React.Dispatch<React.SetStateAction<boolean>>}) => {
  const handleOnClick = () => {
        ...
        <div
          ...
          <div className="flex flex-col p-12 bg-black text-white rounded-2xl w-144 h-144 border-4 border-hacky-green">
            ...
            <p className="text-xs md:text-lg text-left p-0 pt-8 md:p-8 md:pl-16">
              ...
              <li>Indicators will signify if a digit is correct or incorrect
                <ul className="list-disc list-inside ml-8">
                  <li>A red light means the digit is not in the code</li>
                  <li>A yellow light means the digit exists in a different spot in the code</li>
                  <li>A green light means the digit is the correct number in the correct spot in the code</li>
                </ul>
              </li>
